...
solSpeedX = fsolve(@getOffset, -2, options);
disp(solSpeedX)
...
for j = 1:pointsInNewPlot-1
   hold on
   plot([Xpoints(j,1) Xpoints(j+1,1)], [Ypoints(j,1) Ypoints(j+1,1)], 'Color', [0.4940, 0.1840, 0.5560]); 
end
...
for j = 1:(i-pointsInNewPlot-1)
   hold on
   plot([straightX(1,j) straightX(1,j+1)], [straightY(1,j) straightY(1,j+1)], 'Color', [0.6350, 0.0780, 0.1840], 'LineStyle', '--'); 
end

for j = 1:pointsInNewPlot-1
   hold on
   plot([Xpoints(j,1) Xpoints(j+1,1)], [Ypoints(j,1) Ypoints(j+1,1)], 'Color', [0.6350, 0.0780, 0.1840], 'LineStyle', '--'); 
end